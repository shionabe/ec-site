  ...
  <body>
    ...
    try{
      ...
      // $stmt->execute();
        ...
        $sql='INSERT INTO dat_member(password,name,email,postal1,postal2,address,tel,danjo,subpostal1,subpostal2,subaddress)
        VALUES(?,?,?,?,?,?,?,?,?,?,?)';
        $stmt=$dbh->prepare($sql);
        $data=array();
        $data[]=md5($pass);
    ...
    ?>
    <form method="post" action="shop_form.html">
